...
// in my_personal_app/test/widget_test.dart.
...
import 'package:my_personal_app/models/repositories/user_profile_repository.dart'
    as _i2;
import 'package:my_personal_app/models/user_profile.dart' as _i3;
...
class MockUserProfileRepository extends _i1.Mock
  ...
  @override
  List<_i3.UserProfile> getAllProfiles() =>
      (super.noSuchMethod(
            Invocation.method(#getAllProfiles, []),
            returnValue: <_i3.UserProfile>[],
          )
          as List<_i3.UserProfile>);

  @override
  _i3.UserProfile? getProfileById(String? id) =>
